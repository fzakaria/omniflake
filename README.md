...
- **16,853 flakes** in the index, from **17,072 in the library tier** (226 could not be pinned, 0 not yet pinned)
- 1,692 ship no usable lock file and use one computed by Nix
