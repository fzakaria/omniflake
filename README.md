...
- **16,819 flakes** in the index, from **17,038 in the library tier** (226 could not be pinned, 0 not yet pinned)
- 1,691 ship no usable lock file and use one computed by Nix
