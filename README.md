...
- **16,466 flakes** in the index, from **16,685 in the library tier** (227 could not be pinned, 0 not yet pinned)
- 1,663 ship no usable lock file and use one computed by Nix
- 8 held at an earlier revision, their newer one having failed to pin
