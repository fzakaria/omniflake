...
- **12,044 flakes** in the index, from **12,213 in the library tier** (169 could not be pinned, 0 not yet pinned)
- 1,179 ship no usable lock file and use one computed by Nix
