...
- **16,735 flakes** in the index, from **16,954 in the library tier** (227 could not be pinned, 0 not yet pinned)
- 1,680 ship no usable lock file and use one computed by Nix
