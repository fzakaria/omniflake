...
- **16,388 flakes** in the index, from **16,607 in the library tier** (226 could not be pinned, 0 not yet pinned)
- 1,655 ship no usable lock file and use one computed by Nix
