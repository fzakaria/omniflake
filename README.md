...
- **16,410 flakes** in the index, from **16,629 in the library tier** (226 could not be pinned, 0 not yet pinned)
- 1,659 ship no usable lock file and use one computed by Nix
