...
- **16,602 flakes** in the index, from **16,821 in the library tier** (227 could not be pinned, 0 not yet pinned)
- 1,675 ship no usable lock file and use one computed by Nix
