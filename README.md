...
- **16,369 flakes** in the index, from **16,586 in the library tier** (223 could not be pinned, 0 not yet pinned)
- 1,650 ship no usable lock file and use one computed by Nix
