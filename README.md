...
- **16,574 flakes** in the index, from **16,793 in the library tier** (227 could not be pinned, 0 not yet pinned)
- 1,672 ship no usable lock file and use one computed by Nix
