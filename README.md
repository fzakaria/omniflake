...
- **16,438 flakes** in the index, from **16,657 in the library tier** (226 could not be pinned, 0 not yet pinned)
- 1,661 ship no usable lock file and use one computed by Nix
- 7 held at an earlier revision, their newer one having failed to pin
