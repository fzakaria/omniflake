...
- **16,317 flakes** in the index, from **16,534 in the library tier** (223 could not be pinned, 0 not yet pinned)
- 1,639 ship no usable lock file and use one computed by Nix
