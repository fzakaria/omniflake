...
- **16,116 flakes** in the index, from **16,332 in the library tier** (218 could not be pinned, 0 not yet pinned)
- 1,614 ship no usable lock file and use one computed by Nix
