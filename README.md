...
- **16,495 flakes** in the index, from **16,714 in the library tier** (227 could not be pinned, 0 not yet pinned)
- 1,664 ship no usable lock file and use one computed by Nix
